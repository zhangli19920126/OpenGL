...
//    }
//
//    Shader lightingShader("practice/02lighting/2.phong/01PhongLight/phong_light.vs", "practice/02lighting/2.phong/01PhongLight/phong_light.fs");
...
//        model = glm::scale(model, glm::vec3(2.2f, 0.5f, 2.2f));
