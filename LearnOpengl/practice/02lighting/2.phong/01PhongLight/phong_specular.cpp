...
//    // ------------------------------------
//    Shader lightingShader("practice/02lighting/2.phong/01PhongLight/phong_specular.vs", "practice/02lighting/2.phong/01PhongLight/phong_specular.fs");
...
//        lightingShader.use();
//        lightingShader.setVec3("baseColor", 1.0f, 0.5f, 0.31f);
//        lightingShader.setVec3("lightColor", 1.0f, 1.0f, 1.0f);
//        lightingShader.setFloat("ambientRate", ambient);
//        lightingShader.setFloat("specularStrength", specularStrength);
//        lightingShader.setInt("specularPow", specularPow);
//        lightingShader.setVec3("lightPos", glm::vec3(lightPos[0], lightPos[1], lightPos[2]));
...
//        ImGui::SliderInt("specularPow", &specularPow, 1, 128);
//        ImGui::Checkbox("enable mouse", &enableMouse);
//        ImGui::SliderFloat3("lightPos", lightPos, -2.0f, 2.0f);
