...
//float lightPos[3] = { 0.0, 0.0f, -1.0f };
...
//    // ------------------------------------
//    Shader lightingShader("practice/02lighting/3.lighttypes/pointlight/pointlight.vs", "practice/02lighting/3.lighttypes/pointlight/pointlight.fs");
...
//        lightingShader.use();
//        //set light data 
//        lightingShader.setVec3("pointLight.position", glm::vec3(lightPos[0], lightPos[1], lightPos[2]));
//        lightingShader.setVec3("pointLight.color", glm::vec3(lightCol[0], lightCol[1], lightCol[2]));
...
//        ImGui::SliderFloat3("lightPos", lightPos, -7.0f, 7.0f);
