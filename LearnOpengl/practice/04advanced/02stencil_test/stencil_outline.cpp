...
//    Shader ourShader("practice/04advanced/02stencil_test/stencil_outline_model.vs", "practice/04advanced/02stencil_test/stencil_outline_model.fs");
//    Shader outlineShader("practice/04advanced/02stencil_test/stencil_outline.vs", "practice/04advanced/02stencil_test/stencil_outline.fs");
//
//    // load models
...
//        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT); //深度和模板测试都会被清理为0
//
...
//        outlineShader.setFloat("outline", outline * modelScale / 10.0f);
//        ourModel.Draw(ourShader);
//
//        //reset
//        glStencilMask(0xFF);
...
//        ImGui::SliderFloat("mod y rotation", &yrotation, -180.0f, 180.0f);
//        ImGui::SliderFloat("mod x rotation", &xrotation, -180.0f, 180.0f);
