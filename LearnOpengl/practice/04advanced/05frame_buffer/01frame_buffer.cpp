...
//    unsigned int cubeTexture = imgLoader.loadTexture("resources/textures/sex.jpg");
//    unsigned int floorTexture = imgLoader.loadTexture("resources/textures/metal.png");
//
//    // build and compile shaders
//    Shader shader("practice/04advanced/05frame_buffer/01frame_buffer.vs", "practice/04advanced/05frame_buffer/01frame_buffer.fs");
//    Shader screenShader("practice/04advanced/05frame_buffer/01frame_buffer_screen.vs", "practice/04advanced/05frame_buffer/01frame_buffer_screen.fs");
//    shader.use();
