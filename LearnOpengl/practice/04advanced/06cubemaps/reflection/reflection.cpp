...
int main()
{
    ...
    Shader sceneShader("practice/04advanced/06cubemaps/reflection/reflection.vs", "practice/04advanced/06cubemaps/reflection/reflection.fs");
    sceneShader.use();
    sceneShader.setInt("texture1", 0);
    sceneShader.setInt("skybox", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        sceneShader.setFloat("reflectionRate", reflectionRate);
        ...
        ImGui::SliderFloat("reflectionRate", &reflectionRate, 0.0f, 1.0f);
